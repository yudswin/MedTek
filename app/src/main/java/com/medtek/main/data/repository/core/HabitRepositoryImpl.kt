...
class HabitRepositoryImpl @Inject constructor(
    ...
    override suspend fun getHabitsByDayPlanId(dayPlanId: Int): Resource<List<Habit>> {
        Log.d("HabitRepositoryImpl", "getHabitsByDayPlanId: Fetching habits for dayPlanId $dayPlanId started")
        return try {
            val habits = habitDao.getHabitsByDayPlanId(dayPlanId)
            Log.d("HabitRepositoryImpl", "getHabitsByDayPlanId: Fetching habits completed successfully")
            Resource.Success(habits)
        } catch (e: Exception) {
            Log.e("HabitRepositoryImpl", "getHabitsByDayPlanId: Error fetching habits - ${e.localizedMessage}")
    ...
    override suspend fun insertDayPlan(dayPlan: DayPlan): Resource<Long> {
        ...
        return try {
            ...
            Log.d("HabitRepositoryImpl", "insertDayPlan: Inserting day plan completed successfully with ID $id")
            Resource.Success(id)
        } catch (e: Exception) {
            Log.e("HabitRepositoryImpl", "insertDayPlan: Error inserting day plan - ${e.localizedMessage}")
            Resource.Error(e.localizedMessage ?: "An unexpected error occurred")
        }
    }
    ...
    override suspend fun getDayPlansByDate(date: String): Resource<List<DayPlan>> {
        ...
        return try {
            ...
            Log.d("HabitRepositoryImpl", "getDayPlansByDate: Fetching day plans completed successfully")
            Resource.Success(dayPlans)
        } catch (e: Exception) {
            Log.e("HabitRepositoryImpl", "getDayPlansByDate: Error fetching day plans - ${e.localizedMessage}")
            Resource.Error(e.localizedMessage ?: "An unexpected error occurred")
        }
    }
    ...
    override suspend fun getAllDayPlansByUserId(userId: String): Resource<List<DayPlan>> {
        return withContext(Dispatchers.IO) {
            Log.d("HabitRepositoryImpl", "getAllDayPlansByUserId: Fetching all day plans for userId $userId started")
            try {
                val dayPlans = dayPlanDao.getAllDayPlansByUserId(userId)
                Log.d("HabitRepositoryImpl", "getAllDayPlansByUserId: Fetching all day plans completed successfully")
                Resource.Success(dayPlans)
            } catch (e: Exception) {
                Log.e("HabitRepositoryImpl", "getAllDayPlansByUserId: Error fetching all day plans - ${e.localizedMessage}")
    ...
    override suspend fun updateProgressByHabitId(trackingId: String, amount: Int): Resource<Unit> {
        Log.d("HabitRepositoryImpl", "updateProgressByHabitId: Updating progress for habitId $trackingId started")
        return try {
            ...
            Log.d("HabitRepositoryImpl", "updateProgressByHabitId: Updating progress completed successfully")
            Resource.Success(Unit)
        } catch (e: Exception) {
            Log.e("HabitRepositoryImpl", "updateProgressByHabitId: Error updating progress - ${e.localizedMessage}")
            Resource.Error(e.localizedMessage ?: "An unexpected error occurred")
        }
    }
}